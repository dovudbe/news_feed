...
ErrorPageView,SportNewsView,TechnologyNewsView,\
ForeignNewsView,LocalNewsView,NewsUpdateView,NewsCreateView, NewsDeleteView, admin_page_view, SearchResultList
